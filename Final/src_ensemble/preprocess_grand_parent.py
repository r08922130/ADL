...
class Preprocess:
    ...
    def get_start_end(self,text,value):
        ...
        #print(self.tokenizer.decode(self.tokenizer.encode_plus(text)['input_ids']))
        #print(self.tokenizer.decode(self.tokenizer.encode_plus(text)['input_ids'][start:end+1]))
    ...
    def process(self):
        ...
        for f,file in enumerate(files):
            ...
            for row in rows:
                ...
                if not via_money and text[:2] ==  "２．":
                    via_money = True
                if via_money and text[:2] ==  "３．":
                    via_money = False
                ...
                if not none[self.dic['Parent Index']]:
                    ...
                    if row[self.dic['Parent Index']] in parent_dict.keys() and key > 30:
                        ...
                        encoded_text = self.tokenizer.encode_plus(encoded_text,parent_dict[row[self.dic['Parent Index']]] +title_data[row[self.dic['Parent Index']]],max_length=self.max_length, pad_to_max_length=True, add_special_tokens=True, return_tensors='pt')
                    else:
            ...
            for key in text_data.keys():
                ...
                if train:
                    ...
                    if self.train:
                        preprocessed_data[-1]['tags'] = tags
                        preprocessed_data[-1]['starts'] = starts
                        preprocessed_data[-1]['ends'] = ends
                else:
        ...
        print(max_leng)    
        return preprocessed_data,preprocessed_not_for_train
