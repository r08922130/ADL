...
#threshold = [0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.7,0.8,0.9,0.8,0.95,0.95,0.9]
threshold = [0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.95,0.9,0.8,0.8,0.9,0.9,0.9,0.9,0.9]
"""threshold = [0.95]*20
threshold[2]=0.9
threshold[13]=0.85"""
...
with open(f'pred_{mode}_{ver}_thres.csv', 'w', newline='') as csvFile:
