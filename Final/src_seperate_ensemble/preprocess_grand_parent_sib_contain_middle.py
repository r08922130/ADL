...
class Preprocess:
    ...
    def process(self):
            ...
            for row in rows:
                ...
                if not none[self.dic['Parent Index']]:
                    ...
                    if row[self.dic['Parent Index']] in parent_dict.keys():
                        ...
                        encoded_text = self.tokenizer.encode_plus(encoded_text,parent_dict[row[self.dic['Parent Index']]]+[self.tokenizer.sep_token] +title_data[row[self.dic['Parent Index']]]+brother,max_length=self.max_length, pad_to_max_length=True, add_special_tokens=True, return_tensors='pt')
                    else:
            ...
            for key in text_data.keys():
                ...
                if train:
                    ...
                    if part %2 ==1:
                        ...
                        if self.train:
                            preprocessed_data_middle[-1]['tags'] = tags[10:11]
                            preprocessed_data_middle[-1]['starts'] = starts[10:11]
                            preprocessed_data_middle[-1]['ends'] = ends[10:11]
                    else:
                        preprocessed_not_for_train += [{
                            'file_id' : file_id,
                            'index' : key,
        ...
        print(max_leng)    
        return preprocessed_data,preprocessed_data_2,preprocessed_not_for_train,preprocessed_data_middle
