...
### WARNING ###
If you just want to finish homework, you don't need to read and understand this part.
What you can find here are tedious preprocessing tricks .
(however in most time these tricks influence performance most).
